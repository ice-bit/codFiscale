...
describe("Testing codFisc.ts file", () => {
    ...
    test("getBirthPlace method should returns the city code for Italian citizens", () => {
        const identity: Identity = {
            surname: "",
            name: "",
            sex: "",
        ...
        codFisc.getBirthPlace(identity).then(actual => {
            expect(actual.codFiscale).toEqual("F205");
        });
    });

    test("getControlCode method should returns a single control character", () => {
        const identity: Identity = {
            surname: "Rossi",
            name: "Mario",
            sex: "male",
    ...
    test("getCF method should returns a CF for a given citizen", () => {
        const identity: Identity = {
            surname: "Rossi",
            name: "Mario",
            sex: "male",
